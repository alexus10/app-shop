        ...
        <div class="section">
            ...
            {{ csrf_field() }}
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group label-floating">
                            <label class="control-label">Categoía del producto</label>
                ...
                <textarea class="form-control" name="long_description" placeholder="Descripción completa del producto" rows="5">{{ old('long_description', $product->long_description) }}</textarea>
