        ...
        <div class="section text-center section-landing">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <h2 class="title">¿Por qué Add Shop?</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="info">
                            ...
                            <p>Todo pedido que realices será confirmado. Si lo deseas puedes realizar pago contra entrega.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="info">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="team-player">
                            <img src="{{ $category->featured_image_url }}" alt="Thumbnail Image" class="img-raised rounded">
                            <h4 class="title">
        ...
        <div class="section landing-section">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    ...
                    <h4 class="text-center description">Si tienes alguna duda envianos un mensaje y y con gusto te atenderemos.</h4>
...
@section('scripts')
        ...
        <script>
            $(function(){
                ...
                //local: ['Hola', 'Producto1', 'Producto2', 'abcde']
